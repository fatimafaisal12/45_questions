...
console.log("Inequality test with strings: ", ("Pineapple" as string) != "Banana");
...
console.log("number test with Inequality: ", (19 as number) != 90);
...
const fruits :string[] = ["Strawberry", "Guava", "Kiwi"];
